                    ...
                    <li className="splide__slide">
                        <article>
                            <div className='Card'>
                                ...
                                <p>Te permite estar disponible 24/7, lo que facilita que los clientes te encuentren y obtengan información sobre tu negocio en cualquier momento.</p>
                            </div>
                        </article>
                    </li>
                    <li className="splide__slide">
                        <article>
                            <div className='Card'>
                                <h3>Visibilidad</h3>
                                <p>Un sitio web optimizado mejora tu visibilidad en los motores de búsqueda. Ademas, te permite mostrar información importante como teléfono, horarios de atención, ubicación, etc.</p>
                            </div>
                        </article>
                    </li>
                    <li className="splide__slide">
